...
โครงงาน Python File I/O - ใช้ไฟล์ไบนารีและโมดูล struct
พร้อมระบบแบน ID อัตโนมัติเมื่อเกินกำหนดคืน และแบนต่ออีก 30 วัน

คุณสมบัติ:
- ใช้ไฟล์ไบนารี 3 ไฟล์ (books.dat, members.dat, borrows.dat)
- Fixed-length records พร้อม struct format
- CRUD operations ครบถ้วน
- ระบบยืม-คืนหนังสือพร้อมตรวจสอบการเกินกำหนด
- สร้างรายงานข้อความ (library_report.txt)
"""
